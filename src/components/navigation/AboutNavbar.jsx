...
function AboutNavbar({off_background, on_background}) {
    ...
    return (
        <Disclosure as="nav" className={`${navbaron ? 'bg-blue-800 dark:bg-gray-900 shadow ' : "md:bg-transparent bg-blue-900  dark:bg-gray-900 "} transition duration-500 ease-in-out`}>
                {({ open }) => (
                    <>
