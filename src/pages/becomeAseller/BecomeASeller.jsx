                    ...
                    <div className="flex flex-col self-center bg-gray-50 w-full">
                            ...
                            <div className={`" w-full"`}>
                                <Listbox value={selected} onChange={setSelected}>
                                    ...
                                    <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left rounded-lg border border-gray-300 cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-white focus-visible:ring-offset-orange-300 focus-visible:ring-offset-2 focus-visible:border-indigo-500 sm:text-sm">
                                    ...
                                    <Transition
                                        ...
                                        leaveTo="opacity-0"
                                    >
                                        <Listbox.Options className="absolute w-full py-1 mt-1 overflow-auto text-base rounded-lg border border-gray-300 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
               ...
               <div className="flex flex-col w-full items-center">
                    <div className="flex flex-col self-center bg-gray-50 w-full">
                        ...
                        <textarea 
                            minLength={150}
                            cols="30" rows="7"
                            className="p-2 border border-gray-300 outline-none rounded-lg bg-gray-50"
                    ...
                    <div className="flex flex-col self-center bg-gray-50 w-full">
                        ...
                        <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
                            <input 
                                ...
                                className="p-2 col-span-1 border border-gray-300 bg-gray-50 outline-none rounded-lg"
                                onChange={e=> setLevel(e.target.value)}
                            />
                            <input 
                                type="text"
                                placeholder="School Attended"
                                className="p-2 border col-span-2 border-gray-300 bg-gray-50 outline-none rounded-lg"
