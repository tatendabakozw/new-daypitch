           ...
           <div className=" flex flex-col items-center">
               ...
               <div className="flex flex-col w-2/5 items-center">
                    <div className="flex flex-col self-center bg-gray-50 w-full">
                            <p className="text-sm mb-2 text-gray-700 ml-4 font-semibold">Select service category</p>
                            <CategoryList 
                                className=""
                            />
                    </div>
        ...
        <div className={`${className} " w-full"`}>
            <Listbox value={selected} onChange={setSelected}>
                ...
                <Transition
                    ...
                    leaveTo="opacity-0"
                >
                    <Listbox.Options className="absolute w-full py-1 mt-1 overflow-auto text-base bg-white rounded-sm shadow max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
