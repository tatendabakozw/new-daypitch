                ...
                <div className="w-1/4 min-h-screen lg:flex md:hidden hidden flex-col">
                    {
                        userInfo ? (
                            <div className="w-full flex flex-col">
                                ...
                                <span onClick={()=> history.push('/upgrade')} className="bg-blue-900 text-sm p-2 rounded-lg text-white text-center w-2/3 hover:bg-blue-800 cursor-pointer">Upgrade account</span>
                            </div>
                        ):(
                    ...
                    <aside className="hidden xl:block  pt-16">
                        ...
                        <div className="flex items-center space-x-2">
                            <LockOpenIcon className="h-5 w-5 text-blue-400" aria-hidden="true" />
                            <span className="text-green-900 text-sm font-medium">Open Issue</span>
                        </div>
                        <div className="flex items-center space-x-2">
                            <ChatAltIcon className="h-5 w-5 text-gray-400" aria-hidden="true" />
                            <span className="text-gray-900 text-sm font-medium">4 contracts</span>
                        </div>
                        <div className="flex items-center space-x-2">
